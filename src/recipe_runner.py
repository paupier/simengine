...
from failure_modes import DistributionFactory
...
def load_recipe_config(recipe_name: str) -> dict:
    ...
    Also checks the SIMANTHA_RECIPE_PATH env var, then falls back to
    ...
    """
    # Check env var first
    recipe_dir = os.environ.get("SIMANTHA_RECIPE_PATH")
    if recipe_dir:
